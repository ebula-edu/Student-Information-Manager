...
Listah/ │ ├─ assets/ │   ├─ LISTAH.jpg │   ├─ eldrex.png │   ├─ marvs.png │   ├─ marvin.png │   ├─ mark.png │   ├─ jimwel.png │   └─ renzo.png │ ├─ css/ │   └─ main.css │ ├─ js/ │   └─ main.js │ ├─ main.html ├─ index.html └─ README.md
...
2. Open index.html in a browser. This is the loading screen.
...
showForm() displays overlay and focuses on the Name input

hideForm() hides overlay and clears inputs
